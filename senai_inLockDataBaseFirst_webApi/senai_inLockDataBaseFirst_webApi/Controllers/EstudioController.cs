...
using senai_inLockDataBaseFirst_webApi.Repositories;

namespace senai_inLockDataBaseFirst_webApi.Controllers
{
    ...
    public class EstudioController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id,Estudio estudioAlterado) 
        {
            //Faz a chamada para o metodo
